...
List convertHaploFreq_arma(const arma::dcube hap_pth, const arma::dcube sel_cof, const int& evt_gen, const int& int_gen, const int& lst_gen) {
  ...
  arma::dcube phe_pth = arma::zeros<arma::dcube>(3, hap_pth.n_cols, hap_pth.n_slices);
  phe_pth.row(0) = gen_pth.row(0) + gen_pth.row(1) + gen_pth.row(3) + gen_pth.row(4); // bay
  phe_pth.row(1) = gen_pth.row(5) + gen_pth.row(7); // black
  phe_pth.row(2) = gen_pth.row(2) + gen_pth.row(6) + gen_pth.row(8); // chestnut
