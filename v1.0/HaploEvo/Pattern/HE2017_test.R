...
type <- "haplotype"
hap_frq_pth <- cmpsimulateTLWFMS(type, sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen)
...
#' simulate the genotype frequency trajectories
type <- "genotype"
gen_frq_pth <- cmpsimulateTLWFMS(type, sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen)
...
#' simulate the haplotype frequency trajectories
type <- "haplotype"
hap_frq_pth <- cmpsimulateTLWFDS(type, sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen, ptn_num, data_augmentation = TRUE)

t <- (int_gen + (0:((lst_gen - int_gen) * ptn_num)) / ptn_num) / 2 / pop_siz
plot(t, hap_frq_pth[1, ], type = "l", lwd = 1.5, 
     xlab = "Generation", ylab = "Haplotype frequency", 
     main = "A frequency trajectory of the KM0sb1 haplotype generated with the Wright-Fisher diffusion")
plot(t, hap_frq_pth[2, ], type = "l", lwd = 1.5, 
     xlab = "Generation", ylab = "Haplotype frequency", 
     main = "A frequency trajectory of the KM0SB1 haplotype generated with the Wright-Fisher diffusion")
plot(t, hap_frq_pth[3, ], type = "l", lwd = 1.5, 
     xlab = "Generation", ylab = "Haplotype frequency", 
     main = "A frequency trajectory of the KM1sb1 haplotype generated with the Wright-Fisher diffusion")
...
#' simulate the genotype frequency trajectories
type <- "genotype"
gen_frq_pth <- cmpsimulateTLWFDS(type, sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen, ptn_num, data_augmentation = TRUE)

t <- (int_gen + (0:((lst_gen - int_gen) * ptn_num)) / ptn_num) / 2 / pop_siz
plot(t, gen_frq_pth[1, ], type = "l", lwd = 1.5,
     xlab = "Generation", ylab = "Genotype frequency",
     main = "A frequency trajectory of the KM0KM0/sb1sb1 genotype generated with the Wright-Fisher diffusion")
plot(t, gen_frq_pth[2, ], type = "l", lwd = 1.5,
     xlab = "Generation", ylab = "Genotype frequency",
     main = "A frequency trajectory of the KM0KM0/sb1SB1 genotype generated with the Wright-Fisher diffusion")
plot(t, gen_frq_pth[3, ], type = "l", lwd = 1.5,
     xlab = "Generation", ylab = "Genotype frequency",
     main = "A frequency trajectory of the KM0KM0/SB1SB1 genotype generated with the Wright-Fisher diffusion")
plot(t, gen_frq_pth[4, ], type = "l", lwd = 1.5,
     xlab = "Generation", ylab = "Genotype frequency",
     main = "A frequency trajectory of the KM0KM1/sb1sb1 genotype generated with the Wright-Fisher diffusion")
plot(t, gen_frq_pth[5, ], type = "l", lwd = 1.5,
     xlab = "Generation", ylab = "Genotype frequency",
     main = "A frequency trajectory of the KM0KM1/sb1SB1 genotype generated with the Wright-Fisher diffusion")
plot(t, gen_frq_pth[6, ], type = "l", lwd = 1.5,
     xlab = "Generation", ylab = "Genotype frequency",
     main = "A frequency trajectory of the KM0KM1/SB1SB1 genotype generated with the Wright-Fisher diffusion")
plot(t, gen_frq_pth[7, ], type = "l", lwd = 1.5,
     xlab = "Generation", ylab = "Genotype frequency",
     main = "A frequency trajectory of the KM1KM1/sb1sb1 genotype generated with the Wright-Fisher diffusion")
plot(t, gen_frq_pth[8, ], type = "l", lwd = 1.5,
     xlab = "Generation", ylab = "Genotype frequency",
     main = "A frequency trajectory of the KM1KM1/sb1SB1 genotype generated with the Wright-Fisher diffusion")
plot(t, gen_frq_pth[9, ], type = "l", lwd = 1.5,
     xlab = "Generation", ylab = "Genotype frequency",
     main = "A frequency trajectory of the KM1KM1/SB1SB1 genotype generated with the Wright-Fisher diffusion")
...
type <- "haplotype"
sim_WFM_hap_frq <- matrix(NA, nrow = 4, ncol = sim_num)
sim_WFD_hap_frq <- matrix(NA, nrow = 4, ncol = sim_num)
for (i in 1:sim_num) {
  print(i)
  sim_WFM_hap_frq[, i] <- cmpsimulateTLWFMS(type, sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen)[, (lst_gen - int_gen) + 1]
  sim_WFD_hap_frq[, i] <- cmpsimulateTLWFDS(type, sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen, ptn_num, data_augmentation = FALSE)[, (lst_gen - int_gen) + 1]
}

save(sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen, ptn_num, sim_num, sim_WFM_hap_frq, sim_WFD_hap_frq, 
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_WFM_vs_WFD.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_WFM_vs_WFD.rda")

pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_WFM_vs_WFD.pdf", width = 20, height = 10)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), oma = c(0, 0, 3, 0), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
hist(sim_WFM_hap_frq[1, ], breaks = seq(min(sim_WFM_hap_frq[1, ], sim_WFD_hap_frq[1, ]), max(sim_WFM_hap_frq[1, ], sim_WFD_hap_frq[1, ]), length.out = 50), freq = FALSE, col = rgb(0.1, 0.1, 0.1, 0.5), 
     xlim = c(min(sim_WFM_hap_frq[1, ], sim_WFD_hap_frq[1, ]), max(sim_WFM_hap_frq[1, ], sim_WFD_hap_frq[1, ])), 
     xlab = "Haplotype frequency", main = "Haplotype KM0sb1")
hist(sim_WFD_hap_frq[1, ], breaks = seq(min(sim_WFM_hap_frq[1, ], sim_WFD_hap_frq[1, ]), max(sim_WFM_hap_frq[1, ], sim_WFD_hap_frq[1, ]), length.out = 50), freq = FALSE, col = rgb(0.8, 0.8, 0.8, 0.5), add = TRUE)
hist(sim_WFM_hap_frq[2, ], breaks = seq(min(sim_WFM_hap_frq[2, ], sim_WFD_hap_frq[2, ]), max(sim_WFM_hap_frq[2, ], sim_WFD_hap_frq[2, ]), length.out = 50), freq = FALSE, col = rgb(0.1, 0.1, 0.1, 0.5), 
     xlim = c(min(sim_WFM_hap_frq[2, ], sim_WFD_hap_frq[2, ]), max(sim_WFM_hap_frq[2, ], sim_WFD_hap_frq[2, ])), 
     xlab = "Haplotype frequency", main = "Haplotype KM0SB1")
hist(sim_WFD_hap_frq[2, ], breaks = seq(min(sim_WFM_hap_frq[2, ], sim_WFD_hap_frq[2, ]), max(sim_WFM_hap_frq[2, ], sim_WFD_hap_frq[2, ]), length.out = 50), freq = FALSE, col = rgb(0.8, 0.8, 0.8, 0.5), add = TRUE)
hist(sim_WFM_hap_frq[3, ], breaks = seq(min(sim_WFM_hap_frq[3, ], sim_WFD_hap_frq[3, ]), max(sim_WFM_hap_frq[3, ], sim_WFD_hap_frq[3, ]), length.out = 50), freq = FALSE, col = rgb(0.1, 0.1, 0.1, 0.5), 
     xlim = c(min(sim_WFM_hap_frq[3, ], sim_WFD_hap_frq[3, ]), max(sim_WFM_hap_frq[3, ], sim_WFD_hap_frq[3, ])), 
     xlab = "Haplotype frequency", main = "Haplotype KM1sb1")
hist(sim_WFD_hap_frq[3, ], breaks = seq(min(sim_WFM_hap_frq[3, ], sim_WFD_hap_frq[3, ]), max(sim_WFM_hap_frq[3, ], sim_WFD_hap_frq[3, ]), length.out = 50), freq = FALSE, col = rgb(0.8, 0.8, 0.8, 0.5), add = TRUE)
hist(sim_WFM_hap_frq[4, ], breaks = seq(min(sim_WFM_hap_frq[4, ], sim_WFD_hap_frq[4, ]), max(sim_WFM_hap_frq[4, ], sim_WFD_hap_frq[4, ]), length.out = 50), freq = FALSE, col = rgb(0.1, 0.1, 0.1, 0.5), 
     xlim = c(min(sim_WFM_hap_frq[4, ], sim_WFD_hap_frq[4, ]), max(sim_WFM_hap_frq[4, ], sim_WFD_hap_frq[4, ])), 
     xlab = "Haplotype frequency", main = "Haplotype KM1SB1")
hist(sim_WFD_hap_frq[4, ], breaks = seq(min(sim_WFM_hap_frq[4, ], sim_WFD_hap_frq[4, ]), max(sim_WFM_hap_frq[4, ], sim_WFD_hap_frq[4, ]), length.out = 50), freq = FALSE, col = rgb(0.8, 0.8, 0.8, 0.5), add = TRUE)
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, smp_frq, pop_frq, 
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_simulated_dataset.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_simulated_dataset.rda")

pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_simulated_dataset.pdf", width = 30, height = 15)
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, smp_frq, pop_frq, 
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_simulated_dataset.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_simulated_dataset.rda")

pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_simulated_dataset.pdf", width = 30, height = 15)
par(mfrow = c(3, 3), oma = c(0, 0, 3, 0), mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
k <- min(smp_gen):max(smp_gen)
plot(k, pop_frq[1, ], type = 'l', lwd = 1.5,
     xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(smp_frq[1, ], pop_frq[1, ]), max(smp_frq[1, ], pop_frq[1, ])),
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, smp_frq, pop_frq, ptn_num, pcl_num, BPF,
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_BPF.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_BPF.rda")
...
pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_BPF_likelihood.pdf", width = 20, height = 10)
...
pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_BPF_particle.pdf", width = 50, height = 50)
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, smp_frq, pop_frq, ptn_num, pcl_num, BPF,
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_BPF.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_BPF.rda")
...
pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_BPF_likelihood.pdf", width = 20, height = 10)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
plot(1:pcl_num, log(lik), type = 'l', 
     xlab = "Number of particles", ylab = "Log likelihood", main = "Log likelihood estimated with the bootstrap particle filter")
dev.off()
...
pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_BPF_particle.pdf", width = 50, height = 50)
par(mfrow = c(11, 9), oma = c(0, 0, 3, 0), mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
for (k in 1:length(smp_gen)) {
  hist(pop_frq_pst_resmp[1, , k], breaks = seq(min(pop_frq_pst_resmp[1, , k], pop_frq_pre_resmp[1, , k]), max(pop_frq_pst_resmp[1, , k], pop_frq_pre_resmp[1, , k]), length.out = 50), freq = FALSE, col = rgb(0.1, 0.1, 0.1, 0.5),
       xlim = c(min(pop_frq_pst_resmp[1, , k], pop_frq_pre_resmp[1, , k], smp_frq[1, k]), max(pop_frq_pst_resmp[1, , k], pop_frq_pre_resmp[1, , k], smp_frq[1, k])),
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, gap_num, OptNum,
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_OptNum.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_OptNum.rda")

opt_pcl_num <- OptNum$opt_pcl_num
log_lik_sdv <- OptNum$log_lik_sdv

pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_OptNum.pdf", width = 10, height = 10)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, gap_num, OptNum,
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_OptNum.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_OptNum.rda")

opt_pcl_num <- OptNum$opt_pcl_num
log_lik_sdv <- OptNum$log_lik_sdv

pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_OptNum.pdf", width = 10, height = 10)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
plot(opt_pcl_num, log_lik_sdv, type = 'b', lwd = 2, 
     xlab = "Particle number", ylab = "Log-likelihood standard deviation", main = "Optimal particle number in the PMMH")
abline(h = 1.7, col = 'red', lty = 2, lwd = 2)
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, smp_frq, pop_frq, ptn_num, pcl_num, itn_num, ER, PA, nap_num, PMMH,
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_PMMH.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_PMMH.rda")

sel_cof_to_chn <- PMMH$sel_cof_to_chn
sel_cof_sb_chn <- PMMH$sel_cof_sb_chn
sel_cof_ts_chn <- PMMH$sel_cof_ts_chn

pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_PMMH_traceplot.pdf", width = 10, height = 15)
...
pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_PMMH_posterior.pdf", width = 20, height = 20)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, smp_frq, pop_frq, ptn_num, pcl_num, itn_num, ER, PA, nap_num, PMMH,
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_PMMH.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_PMMH.rda")

sel_cof_to_chn <- PMMH$sel_cof_to_chn
sel_cof_sb_chn <- PMMH$sel_cof_sb_chn
sel_cof_ts_chn <- PMMH$sel_cof_ts_chn

pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_PMMH_traceplot.pdf", width = 10, height = 15)
par(mfrow = c(3, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
plot(1:itn_num, sel_cof_to_chn[1:itn_num], type = 'l', 
     xlab = "Iteration", ylab = "Selection coefficient", main = "Trace plot of selection coefficient of tobiano coat")
abline(h = sel_cof[1], col = 'red', lty = 2, lwd = 2)
...
pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_PMMH_posterior.pdf", width = 20, height = 20)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
layout(matrix(c(1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 5, 6), nrow = 6, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_to_chn, sel_cof_sb_chn, n = grd_num)
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, itn_num, ER, PA, brn_num, thn_num, est, nap_num, grd_num, BayesianProcedure,
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_BayesianProcedure.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_BayesianProcedure.rda")
...
pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withoutNA_BayesianProcedure_posterior.pdf", width = 10, height = 15)
par(mfrow = c(3, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
hist(sel_cof_to_chn, breaks = seq(min(sel_cof_to_chn), max(sel_cof_to_chn), length.out = 30), freq = FALSE, 
     xlab = "Selection coefficient", main = "Marginal posterior for selection coefficient of tobiano coat")
lines(density(sel_cof_to_chn), lwd = 2, col = 'black')
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, itn_num, ER, PA, brn_num, thn_num, est, nap_num, grd_num, BayesianProcedure,
     file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_BayesianProcedure.rda")

load("./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_BayesianProcedure.rda")
...
pdf(file = "./Output/Output v1.0/HaploEvo/Horse coat pattern/TEST_withNA_BayesianProcedure_posterior.pdf", width = 10, height = 15)
par(mfrow = c(3, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
hist(sel_cof_to_chn, breaks = seq(min(sel_cof_to_chn), max(sel_cof_to_chn), length.out = 30), freq = FALSE, 
     xlab = "Selection coefficient", main = "Marginal posterior for selection coefficient of tobiano coat")
lines(density(sel_cof_to_chn), lwd = 2, col = 'black')
