...
# call C++ functions
sourceCpp("./Code/Code v1.0/HaploEvo/Horse coat pattern/HE2017_cfun.cpp")
...
#' Standard version
simulateTLWFMS <- function(type, sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen) {
...
#' Standard version
simulateTLWFDS <- function(type, sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen, ptn_num, data_augmentation = TRUE) {
...
simulateHMM <- function(model, missing, sel_cof, rec_rat, pop_siz, int_frq, smp_gen, smp_siz, ...) {
  ...
  if (model == "WFM") {
    pop_hap_frq <- cmpsimulateTLWFMS(type = "haplotype", sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen)
  }
  if (model == "WFD") {
    pop_hap_frq <- cmpsimulateTLWFDS(type = "haplotype", sel_cof, rec_rat, pop_siz, int_frq, int_gen, lst_gen, ptn_num, data_augmentation = FALSE)
  }
