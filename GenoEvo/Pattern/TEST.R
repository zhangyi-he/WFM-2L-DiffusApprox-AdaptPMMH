...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, smp_frq, pop_frq, 
     file = "./Output/Output v1.0/GenoEvo/Horse coat pattern/TEST_data.rda")

load("./Output/Output v1.0/GenoEvo/Horse coat pattern/TEST_data.rda")

pdf(file = "./Output/Output v1.0/GenoEvo/Horse coat pattern/TEST_data.pdf", width = 30, height = 15)
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, gap_num, OptNum,
     file = "./Output/Output v1.0/GenoEvo/Horse coat pattern/TEST_OptNum.rda")

load("./Output/Output v1.0/GenoEvo/Horse coat pattern/TEST_OptNum.rda")

opt_pcl_num <- OptNum$opt_pcl_num
log_lik_sdv <- OptNum$log_lik_sdv

pdf(file = "./Output/Output v1.0/GenoEvo/Horse coat pattern/TEST_OptNum.pdf", width = 10, height = 10)
...
save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, mis_cnt, smp_frq, pop_frq, ptn_num, pcl_num, itn_num, ER, PA, nap_num, PMMH,
     file = "./Output/Output v1.0/GenoEvo/Horse coat pattern/TEST_PMMH.rda")

load("./Output/Output v1.0/GenoEvo/Horse coat pattern/TEST_PMMH.rda")

sel_cof_to_chn <- PMMH$sel_cof_to_chn
sel_cof_sb_chn <- PMMH$sel_cof_sb_chn
sel_cof_ts_chn <- PMMH$sel_cof_ts_chn

pdf(file = "./Output/Output v1.0/GenoEvo/Horse coat pattern/TEST_PMMH_traceplot.pdf", width = 10, height = 15)
...
pdf(file = "./Output/Output v1.0/GenoEvo/Horse coat pattern/TEST_PMMH_posterior.pdf", width = 20, height = 20)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
