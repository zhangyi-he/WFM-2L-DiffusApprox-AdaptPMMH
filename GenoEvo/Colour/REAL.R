...
load("./Output/Output v1.0/GenoEvo/Horse coat colour/REAL_data.rda")
...
#      file = "./Output/Output v1.0/GenoEvo/Horse coat colour/REAL_OptNum.rda")
# 
# load("./Output/Output v1.0/GenoEvo/Horse coat colour/REAL_OptNum.rda")
# 
# opt_pcl_num <- OptNum$opt_pcl_num
# log_lik_sdv <- OptNum$log_lik_sdv
# 
# pdf(file = "./Output/Output v1.0/GenoEvo/Horse coat colour/REAL_OptNum.pdf", width = 10, height = 10)
...
save(rec_rat, pop_siz, dom_gen, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, itn_num, ER, PA, nap_num, PMMH,
     file = "./Output/Output v1.0/GenoEvo/Horse coat colour/REAL_PMMH.rda")

load("./Output/Output v1.0/GenoEvo/Horse coat colour/REAL_PMMH.rda")

sel_cof_b_chn <- PMMH$sel_cof_b_chn
sel_cof_c_chn <- PMMH$sel_cof_c_chn

pdf(file = "./Output/Output v1.0/GenoEvo/Horse coat colour/REAL_PMMH_traceplot.pdf", width = 20, height = 10)
...
pdf(file = "./Output/Output v1.0/GenoEvo/Horse coat colour/REAL_PMMH_posterior.pdf", width = 30, height = 20)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
