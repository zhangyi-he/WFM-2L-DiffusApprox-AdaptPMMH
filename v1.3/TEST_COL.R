...
# call R functions
source("./Code/Code v1.0/Code v1.3/RFUN_COL.R")
...
smp_mis_cnt <- sim_HMM_WFM$smp_mis_cnt
...
mis_cnt <- sim_HMM_WFM$smp_mis_cnt
smp_frq <- sim_HMM_WFM$smp_gen_frq
pop_frq <- sim_HMM_WFM$pop_gen_frq
pop_frq[5, ] <- pop_frq[5, ] + pop_frq[7, ]
pop_frq <- pop_frq[-7, ]

save(sel_cof, rec_rat, pop_siz, int_frq, evt_gen, smp_gen, smp_siz, smp_cnt, mis_cnt, smp_frq, pop_frq,
...
system.time(BPF <- cmprunBPF(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num))

save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, BPF,
...
system.time(OptNum <- calculateOptimalParticleNum(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, gap_num))

save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, gap_num, OptNum,
...
pdf(file = "./Output/Output v1.0/Test v1.3/TEST_COL_OptNum.rda.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
system.time(sel_cof_chn <- cmprunPMMH(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, itn_num))

load("./Output/Output v1.0/Test v1.3/TEST_COL_SimData.rda")

save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, itn_num, sel_cof_chn,
...
# pdf(file = "./Output/Output v1.0/Test v1.3/TEST_COL_PMMH_Posterior_SelChange.pdf", width = 16, height = 6)
...
system.time(BayesianProcedure <- cmprunBayesianProcedure(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, itn_num, brn_num, thn_num))

load("./Output/Output v1.0/Test v1.3/TEST_COL_SimData.rda")

save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, mis_cnt, ptn_num, pcl_num, itn_num, brn_num, thn_num, BayesianProcedure,
...
# pdf(file = "./Output/Output v1.0/Test v1.3/TEST_COL_BayesProc_Posterior_SelChange.pdf", width = 16, height = 6)
# par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
# hist(dif_sel_chn[1, ], breaks = seq(min(dif_sel_chn[1, ]), max(dif_sel_chn[1, ]), length.out = 50), freq = FALSE,
#      xlab = "Selection coefficient",
#      main = "Posterior for the change in the sel coeff of the black")
