...
# call R functions
source("./Code/Code v1.1/RFUN_COL.R")
...
save(sel_cof, rec_rat, pop_siz, int_frq, smp_gen, smp_siz, smp_cnt, smp_gen_frq, pop_hap_frq, pop_gen_frq, pop_hap_frq,
     file = "./Output/Output v1.1/TEST_SimData.rda")

load("./Output/Output v1.1/TEST_SimData.rda")

pop_gen_frq[5, ] <- pop_gen_frq[5, ] + pop_gen_frq[7, ]
pop_gen_frq <- pop_gen_frq[-7, ]

pdf(file = "./Output/Output v1.1/TEST_SimData.pdf", width = 16, height = 12)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, BPF,
     file = "./Output/Output v1.1/TEST_BPF.rda")

load("./Output/Output v1.1/TEST_BPF.rda")
...
pdf(file = "./Output/Output v1.1/TEST_BPF_Likelihood.pdf", width = 12, height = 9)
...
pdf(file = "./Output/Output v1.1/TEST_BPF_Particle.pdf", width = 72, height = 66)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, gap_num, OptNum,
     file = "./Output/Output v1.1/TEST_OptNum.rda")

load("./Output/Output v1.1/TEST_OptNum.rda")

opt_pcl_num <- OptNum$opt_pcl_num
log_lik_sdv <- OptNum$log_lik_sdv

pdf(file = "./Output/Output v1.1/TEST_OptNum.rda.pdf", width = 12, height = 9)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, sel_cof_chn,
     file = "./Output/Output v1.1/TEST_PMMH.rda")

load("./Output/Output v1.1/TEST_PMMH.rda")

pdf(file = "./Output/Output v1.1/TEST_PMMH_Traceplot.pdf", width = 12, height = 9)
...
pdf(file = "./Output/Output v1.1/TEST_PMMH_Posterior.pdf", width = 12, height = 9)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, brn_num, thn_num, BayesianProcedure,
     file = "./Output/Output v1.1/TEST_BayesianProcedure.rda")

load("./Output/Output v1.1/TEST_BayesianProcedure.rda")
...
pdf(file = "./Output/Output v1.1/TEST_BayesianProcedure_Posterior.pdf", width = 12, height = 9)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
hist(sel_cof_chn[1, ], breaks = seq(min(sel_cof_chn[1, ]), max(sel_cof_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Marginal posterior for the selection coefficients of the black phenotype")
