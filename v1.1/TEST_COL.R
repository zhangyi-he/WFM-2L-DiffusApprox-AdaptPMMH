...
pdf(file = "./Output/Output v1.0/Test v1.1/TEST_COL_SimData.pdf", width = 16, height = 12)
...
pdf(file = "./Output/Output v1.0/Test v1.1/TEST_COL_BPF_Likelihood.pdf", width = 12, height = 9)
...
pdf(file = "./Output/Output v1.0/Test v1.1/TEST_COL_OptNum.rda.pdf", width = 12, height = 9)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
pdf(file = "./Output/Output v1.0/Test v1.1/TEST_COL_PMMH_Traceplot.pdf", width = 12, height = 9)
...
pdf(file = "./Output/Output v1.0/Test v1.1/TEST_COL_PMMH_Posterior.pdf", width = 12, height = 9)
...
pdf(file = "./Output/Output v1.0/Test v1.1/TEST_COL_BayesProc_Posterior.pdf", width = 12, height = 9)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
hist(sel_cof_chn[1, ], breaks = seq(min(sel_cof_chn[1, ]), max(sel_cof_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for the black")
