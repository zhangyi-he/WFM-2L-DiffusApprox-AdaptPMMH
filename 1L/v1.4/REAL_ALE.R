...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHa_ASIP_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
smp_gen * 8 + 2000
smp_siz <- smp_siz[-(1:3)]
smp_cnt <- smp_gen_cnt_ASIP[2, -(1:3)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHa_ASIP_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_gen * 8 + 2000
smp_siz <- smp_siz[-(1:4)]
smp_cnt <- smp_gen_cnt_ASIP[2, -(1:4)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMH1a_ASIP_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHa_MC1R_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_gen * 8 + 2000
smp_siz <- smp_siz[-(1:3)]
smp_cnt <- smp_gen_cnt_MC1R[2, -(1:3)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHa_MC1R_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_gen * 8 + 2000
smp_siz <- smp_siz[-(1:4)]
smp_cnt <- smp_gen_cnt_MC1R[2, -(1:4)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMH1a_MC1R_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_gen * 8 + 2000
smp_siz <- smp_siz[-(1:2)]
smp_cnt <- smp_gen_cnt_KIT13[2, -(1:2)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHa_KIT13_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_cnt <- smp_gen_cnt_KIT13[2, -(1:13)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHa_KIT13_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_cnt <- smp_gen_cnt_KIT13[2, -(1:18)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH1a_KIT13_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_gen * 8 + 2000
smp_siz <- smp_siz[-(1:2)]
smp_cnt <- smp_gen_cnt_KIT16[2, -(1:2)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHa_KIT16_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_gen * 8 + 2000
smp_siz <- smp_siz[-(1:13)]
smp_cnt <- smp_gen_cnt_KIT16[2, -(1:13)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHa_KIT16_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_gen * 8 + 2000
smp_siz <- smp_siz[-(1:18)]
smp_cnt <- smp_gen_cnt_KIT16[2, -(1:18)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH1a_KIT16_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHa_TRPM1_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_gen * 8 + 2000
smp_siz <- smp_siz[-(1:2)]
smp_cnt <- smp_gen_cnt_TRPM1[2, -(1:2)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHa_TRPM1_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_gen * 8 + 2000
smp_siz <- smp_siz[-(1:4)]
smp_cnt <- smp_gen_cnt_TRPM1[2, -(1:4)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH1a_TRPM1_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
...
smp_cnt <- smp_gen_cnt_TRPM1[2, -(1:17)]
smp_cnt
ptn_num <- 5e+00
pcl_num <- 1e+03
itn_num <- 2e+04
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH2a_TRPM1_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
