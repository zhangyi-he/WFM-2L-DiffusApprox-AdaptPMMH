...
# call R functions
source("./Code/Code v1.0/Code 1L/Code v1.4/RFUN_GEN.R")
...
#      file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHg_ASIP.rda")

load("./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHg_ASIP.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHg_ASIP_Traceplot_SelCoeff.pdf", width = 12, height = 12)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHg_ASIP_Posterior_SelCoeff.pdf", width = 24, height = 12)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHg_ASIP_Posterior_SelChange.pdf", width = 12, height = 6)
...
#
# save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, PMMH,
#      file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHg_ASIP.rda")

load("./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHg_ASIP.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHg_ASIP_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before domestication")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHg_ASIP_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHg_ASIP_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMH1g_ASIP_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMH1g_ASIP_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
#
# save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, PMMH,
#      file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHg_MC1R.rda")

load("./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHg_MC1R.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHg_MC1R_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before domestication")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHg_MC1R_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_COL_PMMHg_MC1R_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
#
# save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, PMMH,
#      file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHg_MC1R.rda")

load("./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHg_MC1R.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHg_MC1R_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before domestication")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHg_MC1R_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMHg_MC1R_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMH1g_MC1R_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_COL_PMMH1g_MC1R_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
#
# save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, PMMH,
#      file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_KIT13.rda")

load("./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_KIT13.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_KIT13_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_KIT13_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_KIT13_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
#
# save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, PMMH,
#      file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_KIT13.rda")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_KIT13_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_KIT13_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH1g_KIT13_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH1g_KIT13_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
#
# save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, PMMH,
#      file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_KIT16.rda")

load("./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_KIT16.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_KIT16_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before the Middle Ages")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_KIT16_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_KIT16_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
#
# save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, PMMH,
#      file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_KIT16.rda")

load("./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_KIT16.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_KIT16_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before the Middle Ages")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_KIT16_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_KIT16_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH1g_KIT16_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH1g_KIT16_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
#
# save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, PMMH,
#      file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_TRPM1.rda")

load("./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_TRPM1.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_TRPM1_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_TRPM1_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_GRP_PTN_PMMHg_TRPM1_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
#
# save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, PMMH,
#      file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_TRPM1.rda")

load("./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_TRPM1.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_TRPM1_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before the early Bronze Age")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_TRPM1_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMHg_TRPM1_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH1g_TRPM1_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH1g_TRPM1_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH2g_TRPM1_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.4/REAL_RAW_PTN_PMMH2g_TRPM1_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
