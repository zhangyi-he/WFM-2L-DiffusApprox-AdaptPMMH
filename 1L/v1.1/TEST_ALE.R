...
save(model, sel_cof, dom_par, pop_siz, int_con, smp_gen, smp_siz, smp_cnt, smp_frq, pop_frq,
     file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_SimData.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_ALE_SimData.rda")

pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_SimData.pdf", width = 8, height = 6)
...
save(sel_cof, dom_par, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, BPF,
     file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_BPF.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_ALE_BPF.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_BPF_Likelihood.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_BPF_Particle.pdf", width = 32, height = 18)
...
save(sel_cof, dom_par, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, gap_num, OptNum,
     file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_OptNum.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_ALE_OptNum.rda")

opt_pcl_num <- OptNum$opt_pcl_num
log_lik_sdv <- OptNum$log_lik_sdv

pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_OptNum.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
save(sel_cof, dom_par, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, sel_cof_chn,
     file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_PMMH.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_ALE_PMMH.rda")

pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_PMMH_Traceplot.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_PMMH_Autocorrplot.pdf", width = 8, height = 12)
...
save(sel_cof, dom_par, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, brn_num, thn_num, BayesianProcedure,
     file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_BayesProc.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_ALE_BayesProc.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_ALE_BayesProc_Posterior.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn, breaks = seq(min(sel_cof_chn), max(sel_cof_chn), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for the selection coefficient")
