...
save(model, sel_cof, rec_rat, pop_siz, int_con, smp_gen, smp_siz, obs_hap, smp_cnt, smp_frq, pop_frq,
     file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_SimData.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_PTN_SimData.rda")

pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_SimData.pdf", width = 24, height = 18)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, BPF,
     file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_BPF.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_PTN_BPF.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_BPF_Likelihood.pdf", width = 8, height = 6)
...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_BPF_Particle.pdf", width = 72, height = 66)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, gap_num, OptNum,
     file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_OptNum.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_PTN_OptNum.rda")

opt_pcl_num <- OptNum$opt_pcl_num
log_lik_sdv <- OptNum$log_lik_sdv

pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_OptNum.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, sel_cof_chn,
     file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_PMMH.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_PMMH_Autocorrplot.pdf", width = 24, height = 12)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, sel_cof_chn,
     file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_AdaptPMMH.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_AdaptPMMH_Autocorrplot.pdf", width = 24, height = 12)
par(mfrow = c(2, 3), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
effectiveSize(as.mcmc(t(sel_cof_chn)))
...
save(sel_cof, rec_rat, pop_siz, ref_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, brn_num, thn_num, adp_set, stp_siz, apt_rto, BayesianProcedure,
     file = "./Output/Output v1.0/TEST v1.1/TEST_PTN_BayesProc.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_PTN_BayesProc.rda")
