...
# call R functions
source("./Code/Code v1.0/Code 2L/Code v1.2/RFUN_COL.R")
...
save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, BPF,
     file = "./Output/Output v1.0/TEST v1.2/TEST_COL_BPF.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_COL_BPF.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_BPF_Likelihood.pdf", width = 8, height = 6)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_BPF_Particle.pdf", width = 72, height = 66)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_PMMH_Autocorrplot.pdf", width = 16, height = 24)
...
# pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_PMMH_Posterior_SelChange.pdf", width = 8, height = 12)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_AdaptPMMH_Traceplot_SelCoeff.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for sel coeff of black pre-event")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_AdaptPMMH_Autocorrplot.pdf", width = 16, height = 24)
par(mfrow = c(4, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
# effectiveSize(as.mcmc(t(sel_cof_chn)))
...
# pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_AdaptPMMH_Posterior_SelCoeff.pdf", width = 16, height = 12)
# par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
# hist(sel_cof_chn[1, 1, ], breaks = seq(min(sel_cof_chn[1, 1, ]), max(sel_cof_chn[1, 1, ]), length.out = 50), freq = FALSE,
#      xlab = "Selection coefficient",
#      main = "Posterior for sel coeff of black pre-event")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_AdaptPMMH_Posterior_SelCoeff.pdf", width = 16, height = 16)
par(cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 4, 4, 2, 3, 5, 6), nrow = 4, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, 1, ], sel_cof_chn[2, 1, ], n = grd_num)
...
# pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_AdaptPMMH_Posterior_SelChange.pdf", width = 8, height = 12)
# par(mfrow = c(2, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
# hist(dif_sel_chn[1, ], breaks = seq(min(dif_sel_chn[1, ]), max(dif_sel_chn[1, ]), length.out = 50), freq = FALSE,
#      xlab = "Selection coefficient",
#      main = "Posterior for change in sel coeff of black")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_AdaptPMMH_Posterior_SelChange.pdf", width = 16, height = 16)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 3, 3, 2, 2, 4, 5), nrow = 4, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, 1, ], sel_cof_chn[1, 2, ], n = grd_num)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, brn_num, thn_num, adp_set, stp_siz, apt_rto, BayesianProcedure,
     file = "./Output/Output v1.0/TEST v1.2/TEST_COL_BayesProc.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_COL_BayesProc.rda")
...
# pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_BayesProc_Posterior_SelCoeff.pdf", width = 16, height = 12)
# par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
# hist(sel_cof_chn[1, 1, ], breaks = seq(min(sel_cof_chn[1, 1, ]), max(sel_cof_chn[1, 1, ]), length.out = 50), freq = FALSE,
#      xlab = "Selection coefficient",
#      main = "Posterior for sel coeff of black pre-event")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_BayesProc_Posterior_SelCoeff.pdf", width = 16, height = 16)
par(cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 4, 4, 2, 3, 5, 6), nrow = 4, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, 1, ], sel_cof_chn[2, 1, ], n = grd_num)
...
# pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_BayesProc_Posterior_SelChange.pdf", width = 8, height = 12)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_COL_BayesProc_Posterior_SelChange.pdf", width = 16, height = 16)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 3, 3, 2, 2, 4, 5), nrow = 4, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, 1, ], sel_cof_chn[1, 2, ], n = grd_num)
