...
save(model, sel_cof, rec_rat, pop_siz, int_con, evt_gen, smp_gen, smp_siz, obs_hap, smp_cnt, smp_frq, pop_frq,
     file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_SimData.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_2L_COL_SimData.rda")

pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_SimData.pdf", width = 24, height = 18)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, BPF,
     file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_BPF.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_2L_COL_BPF.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_BPF_Likelihood.pdf", width = 8, height = 6)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_BPF_Particle.pdf", width = 72, height = 66)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, gap_num, OptNum,
     file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_OptNum.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_2L_COL_OptNum.rda")

opt_pcl_num <- OptNum$opt_pcl_num
log_lik_sdv <- OptNum$log_lik_sdv

pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_OptNum.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, sel_cof_chn,
     file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_PMMH.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_2L_COL_PMMH.rda")

pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_PMMH_Traceplot_SelCoeff.pdf", width = 16, height = 12)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_PMMH_Posterior_SelCoeff.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_PMMH_Posterior_SelChange.pdf", width = 16, height = 6)
...
save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, sel_cof_chn,
     file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_AdaptPMMH.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_2L_COL_AdaptPMMH.rda")

pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_AdaptPMMH_Traceplot_SelCoeff.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient of black pre-event")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_AdaptPMMH_Posterior_SelCoeff.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn[1, 1, ], breaks = seq(min(sel_cof_chn[1, 1, ]), max(sel_cof_chn[1, 1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient of black pre-event")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_AdaptPMMH_Posterior_SelChange.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn[1, ], breaks = seq(min(dif_sel_chn[1, ]), max(dif_sel_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for change in selection coefficient of black")
...
save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, brn_num, thn_num, adp_set, stp_siz, apt_rto, BayesianProcedure,
     file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_BayesProc.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_2L_COL_BayesProc.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_BayesProc_Posterior_SelCoeff.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn[1, 1, ], breaks = seq(min(sel_cof_chn[1, 1, ]), max(sel_cof_chn[1, 1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient of black pre-event")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_2L_COL_BayesProc_Posterior_SelChange.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn[1, ], breaks = seq(min(dif_sel_chn[1, ]), max(dif_sel_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for change in selection coefficient of black")
