...
# call R functions
source("./Code/Code v1.0/Code 2L/Code v1.3/RFUN_PTN.R")
...
#      file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH1.rda")

load("./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH1.rda")

pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH1_Traceplot_SelCoeff.pdf", width = 24, height = 12)
...
pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH1_Posterior_SelCoeff.pdf", width = 24, height = 24)
...
pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH1_Posterior_SelChange.pdf", width = 24, height = 24)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
#' Raw data of Wutke et al. (2016) from 3672 BC (Domestication 3500 BC)
load("./Data/REAL_RAW_PTN.rda")
...
sel_cof <- matrix(c(0e+00, 0e+00, 0e+00, 0e+00, 0e+00, 0e+00), nrow = 3, ncol = 2)
rec_rat <- 1e-08 * 4688
pop_siz <- pop_siz[-(1:(smp_gen[13] - smp_gen[1]))]
ref_siz <- 1.6e+04
evt_gen <- round(400 - 2000) / 8  # 3500 BC (the Middle Ages)
...
#
# save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, sel_cof_chn,
#      file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH2.rda")

load("./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH2.rda")

pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH2_Traceplot_SelCoeff.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.5, cex.sub = 1.25, cex.axis = 1.25, cex.lab = 1.25)
plot(1:itn_num, sel_cof_chn[1, 1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient of tobiano before the Middle Ages")
...
pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH2_Posterior_SelCoeff.pdf", width = 24, height = 24)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 4, 4, 2, 3, 5, 6), nrow = 4, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, 1, ], sel_cof_chn[2, 1, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH2_Posterior_SelChange.pdf", width = 24, height = 24)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 3, 3, 2, 2, 4, 5), nrow = 4, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, 1, ], sel_cof_chn[1, 2, ], n = grd_num)
...
#' Raw data of Wutke et al. (2016) from 4304 BC (Domestication 3500 BC)
load("./Data/REAL_RAW_PTN.rda")
...
sel_cof <- matrix(c(0e+00, 0e+00, 0e+00, 0e+00, 0e+00, 0e+00), nrow = 3, ncol = 2)
rec_rat <- 1e-08 * 4688
pop_siz <- pop_siz[-(1:(smp_gen[12] - smp_gen[1]))]
ref_siz <- 1.6e+04
evt_gen <- round(400 - 2000) / 8  # 3500 BC (the Middle Ages)
...
#
# save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, sel_cof_chn,
#      file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH3.rda")

load("./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH3.rda")

pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH3_Traceplot_SelCoeff.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.5, cex.sub = 1.25, cex.axis = 1.25, cex.lab = 1.25)
plot(1:itn_num, sel_cof_chn[1, 1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient of tobiano before the Middle Ages")
...
pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH3_Posterior_SelCoeff.pdf", width = 24, height = 24)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 4, 4, 2, 3, 5, 6), nrow = 4, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, 1, ], sel_cof_chn[2, 1, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_RAW_PTN_PMMH3_Posterior_SelChange.pdf", width = 24, height = 24)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 3, 3, 2, 2, 4, 5), nrow = 4, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, 1, ], sel_cof_chn[1, 2, ], n = grd_num)
...
#
# save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, sel_cof_chn,
#      file = "./Output/Output v1.0/REAL v1.3/REAL_GRP_PTN_PMMH.rda")

load("./Output/Output v1.0/REAL v1.3/REAL_GRP_PTN_PMMH.rda")

pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_GRP_PTN_PMMH_Traceplot_SelCoeff.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.5, cex.sub = 1.25, cex.axis = 1.25, cex.lab = 1.25)
plot(1:itn_num, sel_cof_chn[1, 1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient of tobiano before the Middle Ages")
...
pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_GRP_PTN_PMMH_Posterior_SelCoeff.pdf", width = 24, height = 24)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 4, 4, 2, 3, 5, 6), nrow = 4, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, 1, ], sel_cof_chn[2, 1, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.3/REAL_GRP_PTN_PMMH_Posterior_SelChange.pdf", width = 24, height = 24)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 3, 3, 2, 2, 4, 5), nrow = 4, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, 1, ], sel_cof_chn[1, 2, ], n = grd_num)
