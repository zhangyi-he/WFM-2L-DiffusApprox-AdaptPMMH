...
pdf(file = "./Output/Output v1.0/REAL v1.0/REAL_RAW_PTN_PMMH1_Traceplot_SelCoeff.pdf", width = 12, height = 12)
...
pdf(file = "./Output/Output v1.0/REAL v1.0/REAL_RAW_PTN_PMMH1_Posterior_SelCoeff.pdf", width = 24, height = 12)
...
#
# save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, sel_cof_chn,
#      file = "./Output/Output v1.0/REAL v1.0/REAL_RAW_PTN_PMMH2.rda")

load("./Output/Output v1.0/REAL v1.0/REAL_RAW_PTN_PMMH2.rda")

pdf(file = "./Output/Output v1.0/REAL v1.0/REAL_RAW_PTN_PMMH2_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.5, cex.sub = 1.25, cex.axis = 1.25, cex.lab = 1.25)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient of tobiano")
...
pdf(file = "./Output/Output v1.0/REAL v1.0/REAL_RAW_PTN_PMMH2_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
#
# save(sel_cof, rec_rat, pop_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, sel_cof_chn,
#      file = "./Output/Output v1.0/REAL v1.0/REAL_RAW_PTN_PMMH3.rda")

load("./Output/Output v1.0/REAL v1.0/REAL_RAW_PTN_PMMH3.rda")

pdf(file = "./Output/Output v1.0/REAL v1.0/REAL_RAW_PTN_PMMH3_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.5, cex.sub = 1.25, cex.axis = 1.25, cex.lab = 1.25)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient of tobiano")
...
pdf(file = "./Output/Output v1.0/REAL v1.0/REAL_RAW_PTN_PMMH3_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./Output/Output v1.0/REAL v1.0/REAL_GRP_PTN_PMMH_Traceplot_SelCoeff.pdf", width = 12, height = 12)
par(mfrow = c(2, 1), mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.5, cex.sub = 1.25, cex.axis = 1.25, cex.lab = 1.25)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient of tobiano")
...
pdf(file = "./Output/Output v1.0/REAL v1.0/REAL_GRP_PTN_PMMH_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
