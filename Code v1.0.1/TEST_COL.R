...
rec_rat <- 5e-01
pop_siz <- c(rep(1e+04, length.out = 201), rep(5e+03, length.out = 200), rep(1e+04, length.out = 100))
int_con <- c(0.64, 0.16, 0.16, 0.04)
evt_gen <- 240
smp_lab <- 1:220
smp_gen <- rep((0:10) * 50, each = 20)
smp_qua <- c(0.95, 1)
thr_val <- 10

sim_HMM_WFM <- cmpsimulateHMM(model, sel_cof, rec_rat, pop_siz, int_con, evt_gen, smp_lab, smp_gen, smp_qua, thr_val)
tru_smp <- as.data.frame(cbind(sim_HMM_WFM$tru_smp[, 1],
                               sim_HMM_WFM$tru_smp[, 2] * sim_HMM_WFM$tru_smp[, 5],
                               sim_HMM_WFM$tru_smp[, 2] * sim_HMM_WFM$tru_smp[, 6],
                               sim_HMM_WFM$tru_smp[, 2] * sim_HMM_WFM$tru_smp[, 7],
                               sim_HMM_WFM$tru_smp[, 3] * sim_HMM_WFM$tru_smp[, 5],
                               sim_HMM_WFM$tru_smp[, 3] * sim_HMM_WFM$tru_smp[, 6],
                               sim_HMM_WFM$tru_smp[, 4] * sim_HMM_WFM$tru_smp[, 5],
                               sim_HMM_WFM$tru_smp[, 3] * sim_HMM_WFM$tru_smp[, 7],
                               sim_HMM_WFM$tru_smp[, 4] * sim_HMM_WFM$tru_smp[, 6],
                               sim_HMM_WFM$tru_smp[, 4] * sim_HMM_WFM$tru_smp[, 7]))
colnames(tru_smp) <- c("generation", "AA/EE", "AA/Ee", "AA/ee", "Aa/EE", "Aa/Ee", "aa/EE", "Aa/ee", "aa/Ee", "aa/ee")
tru_smp <- aggregate(. ~ generation, data = tru_smp, sum)
smp_gen <- tru_smp[, 1]
smp_siz <- rowSums(tru_smp[, 2:10])
smp_cnt <- t(as.matrix(tru_smp[, 2:10]))
...
sim_HMM_WFD <- cmpsimulateHMM(model, sel_cof, rec_rat, pop_siz, int_con, evt_gen, smp_lab, smp_gen, smp_qua, thr_val, ref_siz, ptn_num)
tru_smp <- as.data.frame(cbind(sim_HMM_WFD$tru_smp[, 1],
                               sim_HMM_WFD$tru_smp[, 2] * sim_HMM_WFD$tru_smp[, 5],
                               sim_HMM_WFD$tru_smp[, 2] * sim_HMM_WFD$tru_smp[, 6],
                               sim_HMM_WFD$tru_smp[, 2] * sim_HMM_WFD$tru_smp[, 7],
                               sim_HMM_WFD$tru_smp[, 3] * sim_HMM_WFD$tru_smp[, 5],
                               sim_HMM_WFD$tru_smp[, 3] * sim_HMM_WFD$tru_smp[, 6],
                               sim_HMM_WFD$tru_smp[, 4] * sim_HMM_WFD$tru_smp[, 5],
                               sim_HMM_WFD$tru_smp[, 3] * sim_HMM_WFD$tru_smp[, 7],
                               sim_HMM_WFD$tru_smp[, 4] * sim_HMM_WFD$tru_smp[, 6],
                               sim_HMM_WFD$tru_smp[, 4] * sim_HMM_WFD$tru_smp[, 7]))
colnames(tru_smp) <- c("generation", "AA/EE", "AA/Ee", "AA/ee", "Aa/EE", "Aa/Ee", "aa/EE", "Aa/ee", "aa/Ee", "aa/ee")
tru_smp <- aggregate(. ~ generation, data = tru_smp, sum)
smp_gen <- tru_smp[, 1]
smp_siz <- rowSums(tru_smp[, 2:10])
...
save(model, sel_cof, rec_rat, pop_siz, int_con, evt_gen, smp_lab, smp_gen, smp_qua, thr_val, sim_HMM_WFM,
     file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_SimData.rda")

load("./Output/Output v1.1/TEST v1.0.1/TEST_COL_SimData.rda")
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_SimData.pdf", width = 24, height = 18)
...
#' @param ref_siz the reference size of the horse population
#' @param evt_gen the generation that the event of interest occurred
#' @param frq_pth the haplotype frequency trajectories of the population
...
ref_siz <- 1e+04
evt_gen <- 240
frq_pth <- sim_HMM_WFM$hap_frq
raw_smp <- sim_HMM_WFM$raw_smp
ptn_num <- 5e+00
pcl_num <- 1e+05

system.time(BPF <- cmprunBPF(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num))

save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, BPF,
     file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_BPF.rda")

load("./Output/Output v1.1/TEST v1.0.1/TEST_COL_BPF.rda")
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_BPF_Likelihood.pdf", width = 8, height = 6)
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_BPF_Particle.pdf", width = 72, height = 66)
...
system.time(OptNum <- calculateOptimalParticleNum(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, gap_num))

save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, gap_num, OptNum,
     file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_OptNum.rda")

load("./Output/Output v1.1/TEST v1.0.1/TEST_COL_OptNum.rda")

opt_pcl_num <- OptNum$opt_pcl_num
log_lik_sdv <- OptNum$log_lik_sdv

pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_OptNum.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
system.time(PMMH <- cmprunPMMH(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, itn_num))

load("./Output/Output v1.1/TEST v1.0.1/TEST_COL_SimData.rda")

save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, itn_num, PMMH,
     file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_PMMH.rda")

load("./Output/Output v1.1/TEST v1.0.1/TEST_COL_PMMH.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_PMMH_Traceplot_SelCoeff.pdf", width = 16, height = 12)
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_PMMH_Posterior_SelCoeff.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn[1, 1, ], breaks = seq(min(sel_cof_chn[1, 1, ]), max(sel_cof_chn[1, 1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient of black pre-event")
...
hist(sel_cof_chn[2, 1, ], breaks = seq(min(sel_cof_chn[2, 1, ]), max(sel_cof_chn[2, 1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient of chestnut pre-event")
...
hist(sel_cof_chn[1, 2, ], breaks = seq(min(sel_cof_chn[1, 2, ]), max(sel_cof_chn[1, 2, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient of black post-event")
...
hist(sel_cof_chn[2, 2, ], breaks = seq(min(sel_cof_chn[2, 2, ]), max(sel_cof_chn[2, 2, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient of chestnut post-event")
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_PMMH_Posterior_SelChange.pdf", width = 16, height = 6)
...
abline(v = sel_cof[1, 2] - sel_cof[1, 1], col = 'red', lty = 2, lwd = 2)
...
abline(v = sel_cof[2, 2] - sel_cof[2, 1], col = 'red', lty = 2, lwd = 2)
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_PMMH_Posterior_Traj.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(raw_smp[, 1]), max(raw_smp[, 1])), ylim = c(min(frq_pth_chn[1, , ], sim_HMM_WFM$hap_frq[1, ]), max(frq_pth_chn[1, , ], sim_HMM_WFM$hap_frq[1, ])),
     xlab = "Generation", ylab = "Haplotype frequency",
     main = "Posterior for underlying trajectory of AE")
for (i in 1:dim(frq_pth_chn)[3]) {
  lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_chn[1, , i], col = 'grey', lty = 1, lwd = 2)
}
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), sim_HMM_WFM$hap_frq[1, ], col = 'red', lty = 1, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_est[1, ], col = 'black', lty = 2, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_hpd[1, 1, ], col = 'blue', lty = 2, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_hpd[1, 2, ], col = 'blue', lty = 2, lwd = 2)

plot(0, type = 'n', xlim = c(min(raw_smp[, 1]), max(raw_smp[, 1])), ylim = c(min(frq_pth_chn[2, , ], sim_HMM_WFM$hap_frq[2, ]), max(frq_pth_chn[2, , ], sim_HMM_WFM$hap_frq[2, ])),
     xlab = "Generation", ylab = "Haplotype frequency",
     main = "Posterior for underlying trajectory of Ae")
for (i in 1:dim(frq_pth_chn)[3]) {
  lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_chn[2, , i], col = 'grey', lty = 1, lwd = 2)
}
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), sim_HMM_WFM$hap_frq[2, ], col = 'red', lty = 1, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_est[2, ], col = 'black', lty = 2, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_hpd[2, 1, ], col = 'blue', lty = 2, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_hpd[2, 2, ], col = 'blue', lty = 2, lwd = 2)

plot(0, type = 'n', xlim = c(min(raw_smp[, 1]), max(raw_smp[, 1])), ylim = c(min(frq_pth_chn[3, , ], sim_HMM_WFM$hap_frq[3, ]), max(frq_pth_chn[3, , ], sim_HMM_WFM$hap_frq[3, ])),
     xlab = "Generation", ylab = "Haplotype frequency",
     main = "Posterior for underlying trajectory of aE")
for (i in 1:dim(frq_pth_chn)[3]) {
  lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_chn[3, , i], col = 'grey', lty = 1, lwd = 2)
}
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), sim_HMM_WFM$hap_frq[3, ], col = 'red', lty = 1, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_est[3, ], col = 'black', lty = 2, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_hpd[3, 1, ], col = 'blue', lty = 2, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_hpd[3, 2, ], col = 'blue', lty = 2, lwd = 2)

plot(0, type = 'n', xlim = c(min(raw_smp[, 1]), max(raw_smp[, 1])), ylim = c(min(frq_pth_chn[4, , ], sim_HMM_WFM$hap_frq[4, ]), max(frq_pth_chn[4, , ], sim_HMM_WFM$hap_frq[4, ])),
     xlab = "Generation", ylab = "Haplotype frequency",
     main = "Posterior for underlying trajectory of ae")
for (i in 1:dim(frq_pth_chn)[3]) {
  lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_chn[4, , i], col = 'grey', lty = 1, lwd = 2)
}
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), sim_HMM_WFM$hap_frq[4, ], col = 'red', lty = 1, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_est[4, ], col = 'black', lty = 2, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_hpd[4, 1, ], col = 'blue', lty = 2, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_hpd[4, 2, ], col = 'blue', lty = 2, lwd = 2)
dev.off()
...
save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, itn_num, PMMH,
     file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_AdaptPMMH.rda")

load("./Output/Output v1.1/TEST v1.0.1/TEST_COL_AdaptPMMH.rda")

sel_cof_chn <- PMMH$sel_cof_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_AdaptPMMH_Traceplot_SelCoeff.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient of black pre-event")
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_AdaptPMMH_Posterior_SelCoeff.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn[1, 1, ], breaks = seq(min(sel_cof_chn[1, 1, ]), max(sel_cof_chn[1, 1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient of black pre-event")
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_AdaptPMMH_Posterior_SelChange.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn[1, ], breaks = seq(min(dif_sel_chn[1, ]), max(dif_sel_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient of black")
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_AdaptPMMH_Posterior_Traj.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(raw_smp[, 1]), max(raw_smp[, 1])), ylim = c(min(frq_pth_chn[1, , ], sim_HMM_WFM$hap_frq[1, ]), max(frq_pth_chn[1, , ], sim_HMM_WFM$hap_frq[1, ])),
     xlab = "Generation", ylab = "Haplotype frequency",
     main = "Posterior for underlying trajectory of AE")
...
system.time(BayesianProcedure <- cmprunBayesianProcedure(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, itn_num, brn_num, thn_num, adp_set, stp_siz, apt_rto))

load("./Output/Output v1.1/TEST v1.0.1/TEST_COL_SimData.rda")

save(sel_cof, rec_rat, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, itn_num, brn_num, thn_num, adp_set, stp_siz, apt_rto, BayesianProcedure,
     file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_BayesProc.rda")

load("./Output/Output v1.1/TEST v1.0.1/TEST_COL_BayesProc.rda")
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_BayesProc_Posterior_SelCoeff.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn[1, 1, ], breaks = seq(min(sel_cof_chn[1, 1, ]), max(sel_cof_chn[1, 1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient of black pre-event")
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_BayesProc_Posterior_SelChange.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn[1, ], breaks = seq(min(dif_sel_chn[1, ]), max(dif_sel_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient of black")
...
pdf(file = "./Output/Output v1.1/TEST v1.0.1/TEST_COL_BayesProc_Posterior_Traj.pdf", width = 16, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(raw_smp[, 1]), max(raw_smp[, 1])), ylim = c(min(frq_pth_chn[1, , ], sim_HMM_WFM$hap_frq[1, ]), max(frq_pth_chn[1, , ], sim_HMM_WFM$hap_frq[1, ])),
     xlab = "Generation", ylab = "Haplotype frequency",
     main = "Posterior for underlying trajectory of AE")
